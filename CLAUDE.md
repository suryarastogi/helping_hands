...
# Type check
uv run ty check src --ignore unresolved-import --ignore invalid-method-override --ignore unused-type-ignore-comment --ignore invalid-assignment --ignore unresolved-attribute
