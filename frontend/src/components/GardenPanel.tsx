/**
 * GardenPanel — compact HUD overlay in Hand World.
 *
 * Shows garden plot/worker counts, connection status, and the
...
export default function GardenPanel({
  ...
  return (
    <div className="zen-status-summary">
      <div className="status-summary-header">Zen Garden</div>
      <div className="status-summary-stat">
        <span className="stat-icon">&#127793;</span>
        <span>{maxWorkers} Plots</span>
      </div>
      <div className="status-summary-stat">
        <span className="stat-icon">&#129302;</span>
        <span>{activeWorkerCount} Gardening</span>
      </div>
