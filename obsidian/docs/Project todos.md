...
- Docstrings: Google-style on all public methods and key private helpers; `_TwoPhaseCLIHand`, `AIProvider` (including all `_build_inner`/`_complete_impl`), skills runners, and meta/tools helpers fully documented.
