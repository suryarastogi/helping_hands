...
- Docstrings: Google-style on all public methods and key private helpers; `_TwoPhaseCLIHand`, `AIProvider` (including all `_build_inner`/`_complete_impl`), skills runners, meta/tools helpers, `_build_agent` methods, and `GitHubClient` context manager fully documented.
- Tests: 569 tests covering filesystem (40), CLI hands (75+), schedule manager (22), Celery helpers (15), skills (30+4 config validation), MCP (17), server app (47), AI providers (28), command/web tools (30+).
