...
*Last updated: 2026-03-01 — All features described above are implemented and tested (624 tests). 38 modules declare `__all__` exports. Goose backend detail expanded. See the repo [[AGENT.md]] for the full recurring decisions log.*
