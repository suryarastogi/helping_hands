...
- **Module `__all__` exports**: Core modules (`config.py`, `repo.py`, `github.py`, `validation.py`, `ai_providers/types.py`, `hand/base.py`, `hand/e2e.py`, `hand/model_provider.py`, `hand/pr_description.py`, `server/schedules.py`, `server/task_result.py`) now declare `__all__` for explicit public API surfaces. (2026-03-01)
...
*Last updated: 2026-03-01 — Module `__all__` exports (11 modules), docstring completion (15 helpers), test_validation.py + E2EHand helper tests + model_provider expansion, Obsidian Concepts.md reconciliation, 624 total tests passing.*
