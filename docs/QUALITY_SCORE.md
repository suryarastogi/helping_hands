...
| `lib/hands/v1/hand/iterative.py` (iteration helpers) | Good (75% -> 76%+) | 80%+ | `_build_iteration_prompt` (basic structure, bootstrap context, previous summary), `_execution_tools_enabled`/`_web_tools_enabled` (true/false/default), `_tool_instructions` (with/without skills), `BasicLangGraphHand._result_content` (empty/none/content attr/str fallback), `BasicAtomicHand._extract_message` (chat_message/empty/none/no attr/string) added in v20 |
