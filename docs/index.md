...
| [design-docs/](design-docs/index.md) | Design documents (core beliefs, hand abstraction, providers, two-phase CLI, testing methodology, error handling, MCP architecture, config loading, repo indexing, scheduling system) |
