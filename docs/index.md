...
- **lib** — Core library: [config](api/lib/config.md), [repo](api/lib/repo.md), [github](api/lib/github.md), [default_prompts](api/lib/default_prompts.md), [ai providers package](api/lib/ai_providers.md), [ai providers types](api/lib/ai_providers/types.md), [openai](api/lib/ai_providers/openai.md), [anthropic](api/lib/ai_providers/anthropic.md), [google](api/lib/ai_providers/google.md), [litellm](api/lib/ai_providers/litellm.md), [ollama](api/lib/ai_providers/ollama.md), [hands v1 package](api/lib/hands/v1/hand.md), [hand base](api/lib/hands/v1/hand/base.md), [hand iterative](api/lib/hands/v1/hand/iterative.md), [hand langgraph](api/lib/hands/v1/hand/langgraph.md), [hand atomic](api/lib/hands/v1/hand/atomic.md), [hand e2e](api/lib/hands/v1/hand/e2e.md), [hand model_provider](api/lib/hands/v1/hand/model_provider.md), [hand pr_description](api/lib/hands/v1/hand/pr_description.md), [hand placeholders](api/lib/hands/v1/hand/placeholders.md), [cli base](api/lib/hands/v1/hand/cli/base.md), [cli claude](api/lib/hands/v1/hand/cli/claude.md), [cli codex](api/lib/hands/v1/hand/cli/codex.md), [cli goose](api/lib/hands/v1/hand/cli/goose.md), [cli gemini](api/lib/hands/v1/hand/cli/gemini.md), [meta skills](api/lib/meta/skills.md), [meta tools package](api/lib/meta/tools.md), [meta tools.filesystem](api/lib/meta/tools/filesystem.md), [meta tools.command](api/lib/meta/tools/command.md), [meta tools.web](api/lib/meta/tools/web.md)
