...
- [Component Coverage](exec-plans/active/2026-03-27-component-coverage.md) —
  AppOverlays + MonitorCard statement/branch coverage improvement;
  697 frontend tests, 90.72% branch coverage (complete)
...
- [2026-03-27 v313–v321](exec-plans/completed/2026/2026-03-27.md) —
  ...
  AppOverlays + MonitorCard component coverage;
  697 tests (frontend), 90.72% branch coverage
