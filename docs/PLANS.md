...
- [2026-03-15 v182](exec-plans/completed/2026/Week-12.md) --
  Move `SUPPORTED_BACKENDS` to `server/constants.py` (DRY frozenset), add
  backend validation and `max_iterations >= 1` validation to MCP
  `build_feature()`; consolidate 2026-03-15.md daily file into Week-12;
  4500 tests (18 new)
