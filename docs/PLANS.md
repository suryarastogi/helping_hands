...
- [Timer Lifecycle Hardening](exec-plans/active/2026-03-27-timer-lifecycle-hardening.md) —
  Fix 5 orphaned setTimeout memory leaks in useMultiplayer hook (emote/chat/cooldown);
  685 frontend tests, 84 backend multiplayer tests

## Completed plans

- [2026-03-27 v313–v320](exec-plans/completed/2026/2026-03-27.md) —
  ...
  App.tsx + useTaskManager branch coverage, edge case hardening;
  681 tests (frontend), 90.23% branch coverage
...
- [2026-03-23 v273–v297](exec-plans/completed/2026/2026-03-23.md) —
  ...
  hooks, types, utils), test co-location, chat bubbles/history, idle detection,
  multiplayer stats, MonitorCard/SubmissionForm/ScheduleCard/TaskListSidebar/
  AppOverlays extraction; 416 tests (frontend)

- [2026-03-17 v247–v272](exec-plans/completed/2026/2026-03-17.md) —
  DRY refactoring, constant extraction, import consolidation, exception narrowing,
  CLI failure helper, MCP path error helper; 490 tests (6298 passed)

- [2026-03-16 v212–v246](exec-plans/completed/2026/2026-03-16.md) —
  Validation hardening, DRY refactoring, finalization cleanup, server test coverage,
  metadata constants, config getattr simplification; 843 tests (5826 passed)
