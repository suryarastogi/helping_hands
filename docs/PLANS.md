...
- [Minimap Click-to-Teleport](exec-plans/active/2026-03-27-minimap-teleport.md) —
  Click on minimap to teleport player; useMovement teleportTo, Minimap onClick,
  crosshair cursor + hover glow CSS; 690 frontend tests (completed)
...
- [2026-03-27 v313–v320](exec-plans/completed/2026/2026-03-27.md) —
  ...
  681 frontend tests, 84 backend multiplayer tests, 90.23% branch coverage
