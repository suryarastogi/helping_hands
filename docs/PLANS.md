...
- [v147](exec-plans/active/v147-ci-fix-loop-resilience-prompt-quality.md) --
  CI fix loop resilience: `_poll_ci_checks` API exception handling with retry, `_build_ci_fix_prompt` URL formatting cleanup, `_ci_fix_loop` exception debug logging
